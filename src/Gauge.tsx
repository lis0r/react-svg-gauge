...
export default class Gauge extends React.Component {
  constructor() {
    ...
    this._getPathValues = (value) => {
      ...
      const dx = 0;
      const dy = 0;
      const alpha = (1 - (value - this.props.min) / (this.props.max - this.props.min)) *
        Math.PI;
  ...
  render() {
    ...
    return (<svg height="100%" version="1.1" width="100%" xmlns="http://www.w3.org/2000/svg" style={{
